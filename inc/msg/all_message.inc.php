...
//GETTING ALL MESSAGE FROM MESSAGE TABLE WHERE USERNAME=USER_LOGIN 
$sql=$dbh->prepare("SELECT *FROM message_tbl WHERE USERNAME=$user_login AND REMOVED='NO'");
$sql->execute();
//CHECK THE NUMBER OF MSG RETURNED
$num_row=$sql->rowCount();
if($num_row==0){
	$message="you have no message yet";
}
else{
