                      ...
                      <li>
                          ...
                          <div class="activities-details">
                                ...
                                <div class="unit">
                                    ...
                                    <div class="input">
                                      <textarea class="form-control"name="post-area" placeholder="your message..." spellcheck="false" id="post-area"></textarea>
                                    </div>
                                </div><br>
                                <!-- end textarea -->
                                <!-- start btn -->
                                <div class="form-footer" style="float:right;">
                                  <input type="submit" class="btn btn-success btn-sms " onclick="loa" id="senpost" name="send-post" value="Post">
                            ...
                            <div class="col-sm-12" style="background-color:#F7F7F7;border-radius:5px;">
                             ...
                             <?php require("inc/post/edit_post.inc.php");?>
