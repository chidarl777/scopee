...
// if everything is ok, try to upload file
	...
	$max=10000000000000000000;
		...
		$post_tracker="post".round(microtime(true)).$encode_username.$post_tracker;
	...
	$STM->execute();
        $profile_pic_query=$dbh->prepare('UPDATE users SET PROFILE_PIC="'.$file.'" WHERE USERNAME="'.$user_login.'" AND REMOVED="NO"');
