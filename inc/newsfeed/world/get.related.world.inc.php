...
try{
	...
	$get_world_post=$dbh->prepare('SELECT *FROM worlds_tbl WHERE WORLD_CATEGORY="'.$world_category.'" AND REMOVED="NO"');
                ...
                <div class="widget-header block-header margin-bottom-0 clearfix">
                    ...
                    <div class="pull-left">
                      <div class="comment-user-thumb">
                                       <a ><img style="width:80px; height:80px; border-radius:10px;" src="'.$profile_pic2.'" alt="world"></a>  &nbsp;&nbsp;&nbsp;<h2 style="float:right;margin-top:5px;"><a >'.$related_w_name.'</a></h2>
                                    </div>
