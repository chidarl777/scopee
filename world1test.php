        ...
        <div class="widget-wrap nav-browse" style="padding-top:5px;padding-bottom:5px; margin-top:0px; display: none;">
            ...
            <div class="btn-group-ex-container">
                <div class="btn-group dropdown">
                    <a href="#" class="btn btn-">Message</a>
                    <a href="#" class="btn btn-warning dropdown-toggle" data-toggle="dropdown"><i class="zmdi zmdi-wrench"></i></a>
          ...
          <div class="e-x-container">
            <div class=" margin-bottom-10">
              <div class="col-md-12">
                ...
                <?php require("editor/worldeditor.php"); ?>
