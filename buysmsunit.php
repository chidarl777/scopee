      ...
      <div class="widget-header block-header margin-bottom-0 clearfix">
		...
		if($num_sql_u_unit>0){
			...
			echo $user_u_sms_unit;
                     ...
                     ?></a></span>
                    	<a href="refillwallet.php">Refill Wallet</a>&nbsp;&nbsp; <a href="sentsms.php?wor=<?php if(isset($_GET['wor'])){ $world_address=$_GET['wor']; echo $world_address;}?>">Sent SMS</a>&nbsp;&nbsp;<a href="sendsms.php?wor=<?php if(isset($_GET['wor'])){ $world_address=$_GET['wor']; echo $world_address;}?>">Send SMS</a>
                    </div>
              ...
              <div class="activities-container">
                  <ul class="activities-list">
                      <li>
                       ...
                       <div class="input">
                       	<input type="text" class="amt-unit" name="amt-to-pay" placeholder="Enter they amount  to pay"/>
                       </div>
                       <div class="sd-input">
                       	<input type="submit" class="btn-send" name="send-amt-unit" value="Submit"/>
                       </div>
                       </form>
