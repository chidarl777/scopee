          ...
          <div class="widget-content">
              <div class="activities-container">
                  <ul class="activities-list">
                      <li>
                      <div class="acc-text">
                        Currently only admins are allowed to refill wallet.<br/>
                        pay in any bank listed below and send they teller number or slip number (normally found at the top of the slip) to 07065180777 or 09055836125
                        <p>
                        	BANK:GTBANK<br/>
                        	ACC/NAME:DARLINGTON NWAOKOROBIA<br/>
                        	ACC/NO:0132067093<br/>
                        	
                        </p>
                        <p>
                        	BANK:UBA<br/>
                        	ACC/NAME:DARLINGTON NWAOKOROBIA<br/>
                        	ACC/NO:2098678673<br/>
                        </p>
                        <p>
                        	BANK:DIAMOND BANK<br/>
                        	ACC/NAME:DARLINGTON NWAOKOROBIA<br/>
                        	ACC/NO: 0041460156<br/>
                        </p>
                        </div>
                      </li>
                      </ul>
