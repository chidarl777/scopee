      ...
      <div class="widget-header block-header margin-bottom-0 clearfix">
		...
		if($num_sql_u_unit>0){
			...
			echo $user_u_sms_unit;
                     ...
                     ?></a></span>
                    	<a href="refillwallet.php">Refill Wallet</a>&nbsp;&nbsp; <a href="buysmsunit.php">Buy Unit</a>&nbsp;&nbsp;<a href="sendsms.php?wor=<?php $world_address=$_GET['wor']; echo $world_address;?>">Send SMS</a>
                    </div>
          ...
          <div class="widget-content">
              <div class="activities-container">
                  <ul class="activities-list">
                      <li>
                          <div class="form-body">
                          <?php require("inc/sms/buyunit.php"); ?>
